...
document.getElementById('reach-eval-form').addEventListener('submit', updateData);
...
function updateData(event) {
  ...
  let reach_ids = document.getElementById("reach_ids").value;
  let model_id = document.getElementById("model_id").value;

  var data = new URLSearchParams();
  data.append('method', 'update_reach_eval_data');
  data.append('start_date', start_date);
  data.append('end_date', end_date);
  data.append('reach_ids', reach_ids);
